...
public class Loan {
    ...
    //Default Constructor
    public Loan(String string, double d, double interestRate, int repaymentYears) {
        this(2.5, 1, 1000);
    }
  ...
  //Construct a loan specified annual interest rate
	...
	int startAge;
	public Loan(String name, double balance, double rate, double paymentAmount, int startAge, int numberOfYears) {
		super();
		this.name = name;
